...
class LiquidacionViajes(db.Model):
    id = db.Column(db.Integer, ForeignKey(
        'cobranzas.id', ondelete='CASCADE'), primary_key=True)
    precio_liquidacion = db.Column(db.Numeric(10, 2), nullable=False)

    id_liquidacion = db.Column(db.Integer, ForeignKey(
